...
export default function PostUpadte() {
    ...
    uploadTask.on(
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
          ...
          setPostFormData({ ...PostFormData, postImage: downloadURL });
  ...
  const PostupdateHandler = async (eo) => {
    eo.preventDefault();
    seterror(null);
    setIsloading(true);
    ...
    <div className="min-h-screen  p-6 pb-3 relative">
      <div className="max-w-4xl mx-auto  p-6 rounded-lg shadow-xl mb-10">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-xl md:text-3xl font-bold">Welcome back Admin!</h1>
          <form
        ...
        <div className="mb-6">
          <h2 className="text-xl font-semibold mb-4">Update your Post!</h2>
